...
STABILIZATION_TIMEOUT_SECONDS = 9.0 #  안정화 최대 대기 시간 (초)
...
ESP32_DISTANCE_URL = "http://192.168.137.218/distance" 
...
FIREBASE_KEY_PATH = "/home/smartrolley/firebase/smartrolley-깃허브용.json"
FIREBASE_STORAGE_BUCKET = "smartrolley-깃허브용.firebasestorage.app" 
FIREBASE_INVENTORY_COLLECTION = "inventory"
FIREBASE_LOCATION_1 = "트롤리 1" # 기본 위치 (메인 카메라)
FIREBASE_LOCATION_2 = "트롤리 2" # ESP32 카메라 위치
FIREBASE_DEFAULT_LOCATION = FIREBASE_LOCATION_1 
